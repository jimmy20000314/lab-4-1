...
.Ltext0:
	...
	.file 0 "/home/jimmy/caravel-soc_fpga-lab/lab-exmem_fir/testbench/counter_la_fir" "fir.c"
	.globl	taps
	.data
	.align	2
	.type	taps, @object
...
.L8:
	...
	sub	a5,a3,a5
	.loc 1 26 37
	lui	a3,%hi(inputsignal)
	addi	a3,a3,%lo(inputsignal)
	slli	a4,a4,2
	add	a4,a3,a4
	lw	a4,0(a4)
	.loc 1 26 25
	lui	a3,%hi(inputbuffer)
	addi	a3,a3,%lo(inputbuffer)
	slli	a5,a5,2
	add	a5,a3,a5
	sw	a4,0(a5)
.L7:
	.loc 1 28 16 discriminator 2
	lui	a5,%hi(taps)
	addi	a4,a5,%lo(taps)
	lw	a5,-24(s0)
	slli	a5,a5,2
